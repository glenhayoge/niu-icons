...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-base p-8 flex flex-col">
      <header className="max-w-4xl mx-auto text-center justify-center relative">
        <div className="flex justify-left container  p-2">
          <img src="/niu-icons.svg" alt="Niu-Icons" className="w-12 h-12 " />
          <h1 className="text-3xl font-bold text-base-content pb-3 ml-4 mb-4 ">NiuIcons</h1>
        </div>
        ...
        <input
          ...
          className="mt-4 px-4 py-2 w-full max-w-4xl input input-bordered rounded-xl input-lg"
        />
      ...
      <div className="flex flex-col items-center justify-center max-w-screen-3xl mx-auto flex-grow">
        <section className="grid grid-cols-9 sm:grid-cols-9 md:grid-cols-9 lg:grid-cols-12 gap-2">
