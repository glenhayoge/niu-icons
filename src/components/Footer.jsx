export default function Footer() {
    return (
        <footer className="mt-12 py-8 max-w-3xl mx-auto w-full text-base-content opacity-70 border-t border-base-300">
            <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center px-4 gap-4">
                <p className="text-sm">Made with ❤️ in Niugini 🇵🇬 </p>
                <a
                    href="https://github.com/glenhayoge/niu-icons"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm hover:underline flex items-center gap-1 transition-colors hover:text-primary"
                >
