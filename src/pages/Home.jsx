        ...
        <div className="hero min-h-[70vh]">
            <div className="hero-content text-center">
                <div className="max-w-md">
                    ...
                    <h1 className="text-5xl font-bold">Niu <span className="text-gray-400">Icons</span></h1>
                    <p className="py-6 text-xl opacity-80">
                        Open source SVG icons, handcrafted with love. Perfect for modern web applications.
                    </p>
